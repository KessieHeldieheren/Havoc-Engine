...
namespace Havoc\Engine\Entity\Boundary\BoundaryRectifier\BoundaryRectifierClamp;
...
/**
 * Havoc Engine entity boundary rectifier for clamping.
 *
 * @package Havoc-Engine
 * @author Kessie Heldieheren <kessie@sdstudios.uk>
 * @version 0.0.0-alpha
 */
class BoundaryRectifierClamp implements BoundaryRectifierInterface
{
    /**
     * Entity.
     *
